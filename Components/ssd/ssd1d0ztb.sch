...
<drawing version="7">
    ...
    <netlist>
        ...
        <block symbolname="lut6" name="XLXI_9">
            <attr value="0000000E3613EF7C" name="INIT">
        ...
        <block symbolname="lut6" name="XLXI_10">
            <attr value="000000057FB3DF71" name="INIT">
                <trait editname="all:1 sch:0" />
                <trait edittrait="all:1 sch:0" />
                <trait verilog="all:0 dp:1nosynth wsynop:1 wsynth:1" />
                <trait vhdl="all:0 gm:1nosynth wa:1 wd:1" />
        ...
        <block symbolname="lut6" name="XLXI_11">
            <attr value="00000008EBF2FD45" name="INIT">
                <trait editname="all:1 sch:0" />
                <trait edittrait="all:1 sch:0" />
                <trait verilog="all:0 dp:1nosynth wsynop:1 wsynth:1" />
                <trait vhdl="all:0 gm:1nosynth wa:1 wd:1" />
        ...
        <block symbolname="lut6" name="XLXI_12">
            <attr value="0000000DF1297B6D" name="INIT">
                <trait editname="all:1 sch:0" />
                <trait edittrait="all:1 sch:0" />
                <trait verilog="all:0 dp:1nosynth wsynop:1 wsynth:1" />
                <trait vhdl="all:0 gm:1nosynth wa:1 wd:1" />
        ...
        <block symbolname="lut6" name="XLXI_13">
            <attr value="00000006D5CF2FFB" name="INIT">
                <trait editname="all:1 sch:0" />
                <trait edittrait="all:1 sch:0" />
                <trait verilog="all:0 dp:1nosynth wsynop:1 wsynth:1" />
                <trait vhdl="all:0 gm:1nosynth wa:1 wd:1" />
        ...
        <block symbolname="lut6" name="XLXI_14">
            <attr value="0000000F478F279F" name="INIT">
                <trait editname="all:1 sch:0" />
                <trait edittrait="all:1 sch:0" />
                <trait verilog="all:0 dp:1nosynth wsynop:1 wsynth:1" />
                <trait vhdl="all:0 gm:1nosynth wa:1 wd:1" />
        ...
        <block symbolname="lut6" name="XLXI_15">
            <attr value="000000081FC1D7ED" name="INIT">
                <trait editname="all:1 sch:0" />
                <trait edittrait="all:1 sch:0" />
                <trait verilog="all:0 dp:1nosynth wsynop:1 wsynth:1" />
                <trait vhdl="all:0 gm:1nosynth wa:1 wd:1" />

...
<drawing version="7">
    ...
    <netlist>
        ...
        <block symbolname="lut6" name="XLXI_9">
            <attr value="0000001C6827DB7C" name="INIT">
        ...
        <block symbolname="lut6" name="XLXI_10">
            <attr value="0000000AFF67BB71" name="INIT">
                <trait editname="all:1 sch:0" />
                <trait edittrait="all:1 sch:0" />
                <trait verilog="all:0 dp:1nosynth wsynop:1 wsynth:1" />
                <trait vhdl="all:0 gm:1nosynth wa:1 wd:1" />
        ...
        <block symbolname="lut6" name="XLXI_11">
            <attr value="00000011D7E5F945" name="INIT">
                <trait editname="all:1 sch:0" />
                <trait edittrait="all:1 sch:0" />
                <trait verilog="all:0 dp:1nosynth wsynop:1 wsynth:1" />
                <trait vhdl="all:0 gm:1nosynth wa:1 wd:1" />
        ...
        <block symbolname="lut6" name="XLXI_12">
            <attr value="0000001BE252F36D" name="INIT">
                <trait editname="all:1 sch:0" />
                <trait edittrait="all:1 sch:0" />
                <trait verilog="all:0 dp:1nosynth wsynop:1 wsynth:1" />
                <trait vhdl="all:0 gm:1nosynth wa:1 wd:1" />
        ...
        <block symbolname="lut6" name="XLXI_13">
            <attr value="0000000DAB9E5BFB" name="INIT">
                <trait editname="all:1 sch:0" />
                <trait edittrait="all:1 sch:0" />
                <trait verilog="all:0 dp:1nosynth wsynop:1 wsynth:1" />
                <trait vhdl="all:0 gm:1nosynth wa:1 wd:1" />
        ...
        <block symbolname="lut6" name="XLXI_14">
            <attr value="0000001E8F1E4B9F" name="INIT">
                <trait editname="all:1 sch:0" />
                <trait edittrait="all:1 sch:0" />
                <trait verilog="all:0 dp:1nosynth wsynop:1 wsynth:1" />
                <trait vhdl="all:0 gm:1nosynth wa:1 wd:1" />
        ...
        <block symbolname="lut6" name="XLXI_15">
            <attr value="000000103F83ABED" name="INIT">
                <trait editname="all:1 sch:0" />
                <trait edittrait="all:1 sch:0" />
                <trait verilog="all:0 dp:1nosynth wsynop:1 wsynth:1" />
                <trait vhdl="all:0 gm:1nosynth wa:1 wd:1" />
    ...
    <sheet sheetnum="1" width="5440" height="3520">
        ...
        <branch name="Segment(6:0)">
            ...
            <wire x2="5120" y1="1360" y2="1440" x1="5120" />
        </branch>

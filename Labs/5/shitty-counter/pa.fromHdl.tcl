...
create_project -name shitty-counter -dir "D:/Classes-2024/Digital System Fundamentals/Labs/5/shitty-counter/planAhead_run_2" -part xc6slx9tqg144-3
set_param project.pinAheadLayout yes
set srcset [get_property srcset [current_run -impl]]
set_property target_constrs_file "integration.ucf" [current_fileset -constrset]
set hdlfile [add_files [list {clkdivh10.vf}]]
